"""
Django settings for resms project.

Configured for Django 5.2 and PostgreSQL.
...
WSGI_APPLICATION = 'resms.wsgi.application'
...
TIME_ZONE = config('TIME_ZONE', default='Asia/Phnom_Penh')
